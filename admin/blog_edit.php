...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        $stmt->bind_param("sssssiii", $title, $description, $content, $content_html, $imageData, $imageType, $category_id, $id);
    } else {
        // 画像以外を更新
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="w-40 h-40 border border-gray-300 rounded-md overflow-hidden">
                                        <img 
                                            ...
                                            onerror="this.onerror=null; this.src='../placeholder.svg?height=160&width=160'; this.alt='画像なし';"
                                        >
                                    </div>
                                </div>
                            </div>
