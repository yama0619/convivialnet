...
// クエリの構築
$sql = "SELECT id, title, description, created_at FROM posts WHERE 1=1";
...
<head>
    ...
    <title>活動記録管理 | Convivial Net</title>
...
<body class="bg-gray-50">
            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between p-4">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-gray-800">活動記録管理</h2>
                    </div>
                    <div class="flex items-center">
            ...
            <main class="flex-1 overflow-y-auto p-4">
                    ...
                    <div class="p-4">
                        <form action="" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-end">
                                ...
                                <a href="activities.php" class="ml-2 px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors">
                                    リセット
                                </a>
                            </div>
                        </form>
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <div class="p-4 border-b flex justify-between items-center">
                        <h3 class="text-lg font-semibold">活動記録一覧</h3>
                        <a href="activity_add.php" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody>
                                        ...
                                        <tr class="border-t border-gray-100 hover:bg-gray-50">
                                            ...
                                            <td class="p-4 text-sm">
                                                <div class="flex space-x-2">
                                                    <a href="../activity_detail.php?id=<?php echo $row['id']; ?>" class="text-gray-600 hover:text-gray-900" target="_blank" title="表示">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="activity_edit.php?id=<?php echo $row['id']; ?>" class="text-blue-600 hover:text-blue-800" title="編集">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="p-4 text-center text-gray-500">活動記録がありません</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p class="mb-4">以下の活動記録を削除してもよろしいですか？</p>
