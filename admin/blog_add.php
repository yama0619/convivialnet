...
// データベースに保存
$stmt = $conn->prepare("INSERT INTO tecblog (title, description, content, content_html, image_data, image_type, category_id, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, NOW())");

$stmt->bind_param("sssssis", $title, $description, $content, $content_html, $imageData, $imageType, $category_id);
          ...
          <div class="bg-white rounded-lg shadow mb-6">
              ...
              <div class="p-6">
                  <form method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-6">
                          <label for="image" class="block text-sm font-medium text-gray-700 mb-1">アイキャッチ画像</label>
                          <input 
                              type="file" 
                              id="image" 
                              name="image" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                          >
                          <p class="text-sm text-gray-500 mt-1">推奨サイズ: 1200 x 630 ピクセル</p>
                      </div>
